...
namespace Inflectra.SpiraTest.ApiTestSuite.Rest_Code_Generation.SpiraRestService60
{
	...
	public partial class SpiraRestClient60
	{
		...
		public void Document_Update(RemoteCredentials credentials, object project_id, RemoteDocument remoteDocument)
		{
			string path = "projects/{project_id}/documents";

            //Create the request
            RestRequest request = new RestRequest("Document_Update");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteDocument);
				Common.Logger.LogTraceEvent("Document_Update", request.Body);
		...
		public RemoteDocumentStatus[] Document_RetrieveStatuses(RemoteCredentials credentials, object project_template_id)
		{
			string path = "project-templates/{project_template_id}/document-statuses";

            //Create the request
            RestRequest request = new RestRequest("Document_RetrieveStatuses");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				{
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteDocumentStatus[] responseObj = JsonConvert.DeserializeObject<RemoteDocumentStatus[]>("", settings);
					return responseObj;
				}
				else
				{
					//Deserialize the response
					Common.Logger.LogTraceEvent("Document_RetrieveStatuses", response.Body);
					RemoteDocumentStatus[] responseObj = JsonConvert.DeserializeObject<RemoteDocumentStatus[]>(response.Body);
		...
		public RemoteDocumentStatus Document_AddStatus(RemoteCredentials credentials, object project_template_id, RemoteDocumentStatus remoteDocumentStatus)
		{
			string path = "project-templates/{project_template_id}/document-statuses";

            //Create the request
            RestRequest request = new RestRequest("Document_AddStatus");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			if (remoteDocumentStatus == null)
			{
				request.Body = "";
			}
			else
			{
				request.Body = JsonConvert.SerializeObject(remoteDocumentStatus);
				Common.Logger.LogTraceEvent("Document_AddStatus", request.Body);
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				{
					//Deserialize the response
					Common.Logger.LogTraceEvent("Document_AddStatus", response.Body);
					RemoteDocumentStatus responseObj = JsonConvert.DeserializeObject<RemoteDocumentStatus>(response.Body);
		...
		public void Document_UpdateStatus(RemoteCredentials credentials, object project_template_id, RemoteDocumentStatus remoteDocumentStatus)
		{
			string path = "project-templates/{project_template_id}/document-statuses";

            //Create the request
            RestRequest request = new RestRequest("Document_UpdateStatus");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteDocumentStatus);
				Common.Logger.LogTraceEvent("Document_UpdateStatus", request.Body);
		...
		public RemoteFloatingLicense FloatingLicense_CreateNewSession(RemoteCredentials credentials, RemoteFloatingLicense floatingLicense)
		{
			string path = "floating-licenses";

            //Create the request
            RestRequest request = new RestRequest("FloatingLicense_CreateNewSession");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			if (floatingLicense == null)
			{
				request.Body = "";
			}
			else
			{
				request.Body = JsonConvert.SerializeObject(floatingLicense);
				Common.Logger.LogTraceEvent("FloatingLicense_CreateNewSession", request.Body);
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				{
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteFloatingLicense responseObj = JsonConvert.DeserializeObject<RemoteFloatingLicense>("", settings);
					return responseObj;
				}
				else
				{
					//Deserialize the response
					Common.Logger.LogTraceEvent("FloatingLicense_CreateNewSession", response.Body);
					RemoteFloatingLicense responseObj = JsonConvert.DeserializeObject<RemoteFloatingLicense>(response.Body);
		...
		public RemoteFloatingLicense FloatingLicense_ExtendSession(RemoteCredentials credentials, object session_id, object automation_engine_token, object automation_host, object expiration_date)
		{
			string path = "floating-licenses/{session_id}/engine/{automation_engine_token}/host/{automation_host}?expiration_date={expiration_date}";

            //Create the request
            RestRequest request = new RestRequest("FloatingLicense_ExtendSession");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			//Map the parameters
			AddRequestParameter(request, "session_id", session_id);
			AddRequestParameter(request, "automation_engine_token", automation_engine_token);
			AddRequestParameter(request, "automation_host", automation_host);
			AddRequestParameter(request, "expiration_date", expiration_date);
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				{
					//Deserialize the response
					Common.Logger.LogTraceEvent("FloatingLicense_ExtendSession", response.Body);
					RemoteFloatingLicense responseObj = JsonConvert.DeserializeObject<RemoteFloatingLicense>(response.Body);
		...
		public Boolean FloatingLicense_ReleaseSession(RemoteCredentials credentials, object session_id, object automation_engine_token, object automation_host)
		{
			string path = "floating-licenses/{session_id}/engine/{automation_engine_token}/host/{automation_host}";

            //Create the request
            RestRequest request = new RestRequest("FloatingLicense_ReleaseSession");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				{
					//Deserialize the response
					Common.Logger.LogTraceEvent("FloatingLicense_ReleaseSession", response.Body);
		...
		public RemoteFloatingLicense FloatingLicense_GetLicenseInfoBySessionId(RemoteCredentials credentials, object session_id, object automation_engine_token, object automation_host)
		{
			string path = "floating-licenses/{session_id}/engine/{automation_engine_token}/host/{automation_host}";

            //Create the request
            RestRequest request = new RestRequest("FloatingLicense_GetLicenseInfoBySessionId");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				{
					//Deserialize the response
					Common.Logger.LogTraceEvent("FloatingLicense_GetLicenseInfoBySessionId", response.Body);
					RemoteFloatingLicense responseObj = JsonConvert.DeserializeObject<RemoteFloatingLicense>(response.Body);
		...
		public RemoteIntegerSetting[] FloatingLicense_GetLicenseCounts(RemoteCredentials credentials, object automation_engine_token)
		{
			string path = "floating-licenses/engine/{automation_engine_token}";

            //Create the request
            RestRequest request = new RestRequest("FloatingLicense_GetLicenseCounts");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				{
					JsonSerializerSettings settings = new JsonSerializerSettings() {DateFormatHandling= DateFormatHandling.MicrosoftDateFormat};
					RemoteIntegerSetting[] responseObj = JsonConvert.DeserializeObject<RemoteIntegerSetting[]>("", settings);
					return responseObj;
				}
				else
				{
					//Deserialize the response
					Common.Logger.LogTraceEvent("FloatingLicense_GetLicenseCounts", response.Body);
					RemoteIntegerSetting[] responseObj = JsonConvert.DeserializeObject<RemoteIntegerSetting[]>(response.Body);
		...
		public void Incident_UpdatePriority(RemoteCredentials credentials, object project_template_id, RemoteIncidentPriority remoteIncidentPriority)
		{
			string path = "project-templates/{project_template_id}/incidents/priorities";

            //Create the request
            RestRequest request = new RestRequest("Incident_UpdatePriority");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteIncidentPriority);
				Common.Logger.LogTraceEvent("Incident_UpdatePriority", request.Body);
		...
		public void Incident_UpdateSeverity(RemoteCredentials credentials, object project_template_id, RemoteIncidentSeverity remoteIncidentSeverity)
		{
			string path = "project-templates/{project_template_id}/incidents/severities";

            //Create the request
            RestRequest request = new RestRequest("Incident_UpdateSeverity");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteIncidentSeverity);
				Common.Logger.LogTraceEvent("Incident_UpdateSeverity", request.Body);
		...
		public void Incident_UpdateStatus(RemoteCredentials credentials, object project_template_id, RemoteIncidentStatus remoteIncidentStatus)
		{
			string path = "project-templates/{project_template_id}/incidents/statuses";

            //Create the request
            RestRequest request = new RestRequest("Incident_UpdateStatus");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteIncidentStatus);
				Common.Logger.LogTraceEvent("Incident_UpdateStatus", request.Body);
		...
		public void Incident_UpdateType(RemoteCredentials credentials, object project_template_id, RemoteIncidentType remoteIncidentType)
		{
			string path = "project-templates/{project_template_id}/incidents/types";

            //Create the request
            RestRequest request = new RestRequest("Incident_UpdateType");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteIncidentType);
				Common.Logger.LogTraceEvent("Incident_UpdateType", request.Body);
		...
		public RemoteRequirementImportance Requirement_AddImportance(RemoteCredentials credentials, object project_template_id, RemoteRequirementImportance remoteRequirementImportance)
		{
			string path = "project-templates/{project_template_id}/requirements/importances";

            //Create the request
            RestRequest request = new RestRequest("Requirement_AddImportance");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			if (remoteRequirementImportance == null)
			{
				request.Body = "";
			}
			else
			{
				request.Body = JsonConvert.SerializeObject(remoteRequirementImportance);
				Common.Logger.LogTraceEvent("Requirement_AddImportance", request.Body);
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				{
					//Deserialize the response
					Common.Logger.LogTraceEvent("Requirement_AddImportance", response.Body);
					RemoteRequirementImportance responseObj = JsonConvert.DeserializeObject<RemoteRequirementImportance>(response.Body);
		...
		public void Requirement_UpdateImportance(RemoteCredentials credentials, object project_template_id, RemoteRequirementImportance remoteRequirementImportance)
		{
			string path = "project-templates/{project_template_id}/requirements/importances";

            //Create the request
            RestRequest request = new RestRequest("Requirement_UpdateImportance");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteRequirementImportance);
				Common.Logger.LogTraceEvent("Requirement_UpdateImportance", request.Body);
		...
		public RemoteRequirementType Requirement_AddType(RemoteCredentials credentials, object project_template_id, RemoteRequirementType remoteRequirementType)
		{
			string path = "project-templates/{project_template_id}/requirements/types";

            //Create the request
            RestRequest request = new RestRequest("Requirement_AddType");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			if (remoteRequirementType == null)
			{
				request.Body = "";
			}
			else
			{
				request.Body = JsonConvert.SerializeObject(remoteRequirementType);
				Common.Logger.LogTraceEvent("Requirement_AddType", request.Body);
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				{
					//Deserialize the response
					Common.Logger.LogTraceEvent("Requirement_AddType", response.Body);
					RemoteRequirementType responseObj = JsonConvert.DeserializeObject<RemoteRequirementType>(response.Body);
		...
		public void Requirement_UpdateType(RemoteCredentials credentials, object project_template_id, RemoteRequirementType remoteRequirementType)
		{
			string path = "project-templates/{project_template_id}/requirements/types";

            //Create the request
            RestRequest request = new RestRequest("Requirement_UpdateType");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteRequirementType);
				Common.Logger.LogTraceEvent("Requirement_UpdateType", request.Body);
		...
		public RemoteRiskImpact Risk_AddImpact(RemoteCredentials credentials, object project_template_id, RemoteRiskImpact remoteRiskImpact)
		{
			string path = "project-templates/{project_template_id}/risks/impacts";

            //Create the request
            RestRequest request = new RestRequest("Risk_AddImpact");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			if (remoteRiskImpact == null)
			{
				request.Body = "";
			}
			else
			{
				request.Body = JsonConvert.SerializeObject(remoteRiskImpact);
				Common.Logger.LogTraceEvent("Risk_AddImpact", request.Body);
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				{
					//Deserialize the response
					Common.Logger.LogTraceEvent("Risk_AddImpact", response.Body);
					RemoteRiskImpact responseObj = JsonConvert.DeserializeObject<RemoteRiskImpact>(response.Body);
		...
		public void Risk_UpdateImpact(RemoteCredentials credentials, object project_template_id, RemoteRiskImpact remoteRiskImpact)
		{
			string path = "project-templates/{project_template_id}/risks/impacts";

            //Create the request
            RestRequest request = new RestRequest("Risk_UpdateImpact");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteRiskImpact);
				Common.Logger.LogTraceEvent("Risk_UpdateImpact", request.Body);
		...
		public RemoteRiskProbability Risk_AddProbability(RemoteCredentials credentials, object project_template_id, RemoteRiskProbability remoteRiskProbability)
		{
			string path = "project-templates/{project_template_id}/risks/probabilities";

            //Create the request
            RestRequest request = new RestRequest("Risk_AddProbability");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			if (remoteRiskProbability == null)
			{
				request.Body = "";
			}
			else
			{
				request.Body = JsonConvert.SerializeObject(remoteRiskProbability);
				Common.Logger.LogTraceEvent("Risk_AddProbability", request.Body);
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				{
					//Deserialize the response
					Common.Logger.LogTraceEvent("Risk_AddProbability", response.Body);
					RemoteRiskProbability responseObj = JsonConvert.DeserializeObject<RemoteRiskProbability>(response.Body);
		...
		public void Risk_UpdateProbability(RemoteCredentials credentials, object project_template_id, RemoteRiskProbability remoteRiskProbability)
		{
			string path = "project-templates/{project_template_id}/risks/probabilities";

            //Create the request
            RestRequest request = new RestRequest("Risk_UpdateProbability");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteRiskProbability);
				Common.Logger.LogTraceEvent("Risk_UpdateProbability", request.Body);
		...
		public RemoteRiskStatus Risk_AddStatus(RemoteCredentials credentials, object project_template_id, RemoteRiskStatus remoteRiskStatus)
		{
			string path = "project-templates/{project_template_id}/risks/statuses";

            //Create the request
            RestRequest request = new RestRequest("Risk_AddStatus");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			if (remoteRiskStatus == null)
			{
				request.Body = "";
			}
			else
			{
				request.Body = JsonConvert.SerializeObject(remoteRiskStatus);
				Common.Logger.LogTraceEvent("Risk_AddStatus", request.Body);
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				{
					//Deserialize the response
					Common.Logger.LogTraceEvent("Risk_AddStatus", response.Body);
					RemoteRiskStatus responseObj = JsonConvert.DeserializeObject<RemoteRiskStatus>(response.Body);
		...
		public void Risk_UpdateStatus(RemoteCredentials credentials, object project_template_id, RemoteRiskStatus remoteRiskStatus)
		{
			string path = "project-templates/{project_template_id}/risks/statuses";

            //Create the request
            RestRequest request = new RestRequest("Risk_UpdateStatus");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteRiskStatus);
				Common.Logger.LogTraceEvent("Risk_UpdateStatus", request.Body);
		...
		public RemoteRiskType Risk_AddType(RemoteCredentials credentials, object project_template_id, RemoteRiskType remoteRiskType)
		{
			string path = "project-templates/{project_template_id}/risks/types";

            //Create the request
            RestRequest request = new RestRequest("Risk_AddType");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			if (remoteRiskType == null)
			{
				request.Body = "";
			}
			else
			{
				request.Body = JsonConvert.SerializeObject(remoteRiskType);
				Common.Logger.LogTraceEvent("Risk_AddType", request.Body);
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				{
					//Deserialize the response
					Common.Logger.LogTraceEvent("Risk_AddType", response.Body);
					RemoteRiskType responseObj = JsonConvert.DeserializeObject<RemoteRiskType>(response.Body);
		...
		public void Risk_UpdateType(RemoteCredentials credentials, object project_template_id, RemoteRiskType remoteRiskType)
		{
			string path = "project-templates/{project_template_id}/risks/types";

            //Create the request
            RestRequest request = new RestRequest("Risk_UpdateType");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteRiskType);
				Common.Logger.LogTraceEvent("Risk_UpdateType", request.Body);
		...
		public RemoteTaskPriority Task_AddPriority(RemoteCredentials credentials, object project_template_id, RemoteTaskPriority remoteTaskPriority)
		{
			string path = "project-templates/{project_template_id}/tasks/priorities";

            //Create the request
            RestRequest request = new RestRequest("Task_AddPriority");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			if (remoteTaskPriority == null)
			{
				request.Body = "";
			}
			else
			{
				request.Body = JsonConvert.SerializeObject(remoteTaskPriority);
				Common.Logger.LogTraceEvent("Task_AddPriority", request.Body);
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				{
					//Deserialize the response
					Common.Logger.LogTraceEvent("Task_AddPriority", response.Body);
					RemoteTaskPriority responseObj = JsonConvert.DeserializeObject<RemoteTaskPriority>(response.Body);
		...
		public void Task_UpdatePriority(RemoteCredentials credentials, object project_template_id, RemoteTaskPriority remoteTaskPriority)
		{
			string path = "project-templates/{project_template_id}/tasks/priorities";

            //Create the request
            RestRequest request = new RestRequest("Task_UpdatePriority");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteTaskPriority);
				Common.Logger.LogTraceEvent("Task_UpdatePriority", request.Body);
		...
		public RemoteTaskType Task_AddType(RemoteCredentials credentials, object project_template_id, RemoteTaskType remoteTaskType)
		{
			string path = "project-templates/{project_template_id}/tasks/types";

            //Create the request
            RestRequest request = new RestRequest("Task_AddType");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteTaskType);
				Common.Logger.LogTraceEvent("Task_AddType", request.Body);
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				{
					//Deserialize the response
					Common.Logger.LogTraceEvent("Task_AddType", response.Body);
					RemoteTaskType responseObj = JsonConvert.DeserializeObject<RemoteTaskType>(response.Body);
		...
		public void Task_UpdateType(RemoteCredentials credentials, object project_template_id, RemoteTaskType remoteTaskType)
		{
			string path = "project-templates/{project_template_id}/tasks/types";

            //Create the request
            RestRequest request = new RestRequest("Task_UpdateType");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteTaskType);
				Common.Logger.LogTraceEvent("Task_UpdateType", request.Body);
		...
		public RemoteTestCasePriority TestCase_AddPriority(RemoteCredentials credentials, object project_template_id, RemoteTestCasePriority remoteTestCasePriority)
		{
			string path = "project-templates/{project_template_id}/test-cases/priorities";

            //Create the request
            RestRequest request = new RestRequest("TestCase_AddPriority");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			if (remoteTestCasePriority == null)
			{
				request.Body = "";
			}
			else
			{
				request.Body = JsonConvert.SerializeObject(remoteTestCasePriority);
				Common.Logger.LogTraceEvent("TestCase_AddPriority", request.Body);
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				{
					//Deserialize the response
					Common.Logger.LogTraceEvent("TestCase_AddPriority", response.Body);
					RemoteTestCasePriority responseObj = JsonConvert.DeserializeObject<RemoteTestCasePriority>(response.Body);
		...
		public void TestCase_UpdatePriority(RemoteCredentials credentials, object project_template_id, RemoteTestCasePriority remoteTestCasePriority)
		{
			string path = "project-templates/{project_template_id}/test-cases/priorities";

            //Create the request
            RestRequest request = new RestRequest("TestCase_UpdatePriority");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteTestCasePriority);
				Common.Logger.LogTraceEvent("TestCase_UpdatePriority", request.Body);
		...
		public RemoteTestCaseType TestCase_AddType(RemoteCredentials credentials, object project_template_id, RemoteTestCaseType remoteTestCaseType)
		{
			string path = "project-templates/{project_template_id}/test-cases/types";

            //Create the request
            RestRequest request = new RestRequest("TestCase_AddType");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteTestCaseType);
				Common.Logger.LogTraceEvent("TestCase_AddType", request.Body);
            ...
            if (!response.IsErrorStatus && response.Headers.FirstOrDefault(h => h.Name == Properties.Resources.Rest_StatusCode).Value == "200 OK")
            {
				...
				{
					//Deserialize the response
					Common.Logger.LogTraceEvent("TestCase_AddType", response.Body);
					RemoteTestCaseType responseObj = JsonConvert.DeserializeObject<RemoteTestCaseType>(response.Body);
		...
		public void TestCase_UpdateType(RemoteCredentials credentials, object project_template_id, RemoteTestCaseType remoteTestCaseType)
		{
			string path = "project-templates/{project_template_id}/test-cases/types";

            //Create the request
            RestRequest request = new RestRequest("TestCase_UpdateType");
			if (credentials != null)
			{
				request.Credential = new System.Net.NetworkCredential();
				request.Credential.UserName = credentials.UserName;
			...
			{
				request.Body = JsonConvert.SerializeObject(remoteTestCaseType);
				Common.Logger.LogTraceEvent("TestCase_UpdateType", request.Body);
	...
	public class RemoteDocumentStatus
	{
	...
	public class RemoteFloatingLicense
	{
			...
			public System.String AutomationHost { get; set; }
	...
	public class RemoteIntegerSetting
	{
